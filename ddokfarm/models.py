...
class FarmSplitPost(FarmBasePost):
    ...
    album = models.CharField(max_length=20, choices=ALBUM_CHOICES, default='include')
    opened = models.CharField(max_length=20, choices=OPENED_CHOICES, default='unopened')
