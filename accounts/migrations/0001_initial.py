    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kakao_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='카카오 ID')),
                ('naver_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='네이버 ID')),
                ('google_id', models.CharField(blank=True, max_length=50, null=True, verbose_name='구글 ID')),
